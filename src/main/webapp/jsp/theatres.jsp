        ...
        <div class="col-md-12" ng-show="filteredItems > 0">
            ...
            <tbody>
                <tr ng-repeat="data in filtered = (list | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit">
                    ...
                    <td><a href="update_theatre.html?id={{data.id}}"><i class="glyphicon glyphicon-file"></i></a> 
                        <a href="delete_theatre.html?id={{data.id}}" onClick="return ConfirmDelete();"><i class="glyphicon glyphicon-trash"></i></a>
                    </td>
...
<script src="jsp/theatres.js"></script>
