...
<!-- <br/> -->
    <div class="row">
        ...
        <div class="col-md-4">
            <h5>Filtered {{ filtered.length }} of {{ totalItems}} total movies</h5>
        </div>
    </div>
    <br/>
    <div class="row">
...
<!--             <th>Credit Limit&nbsp;<a ng-click="sort_by('slika');"><i class="glyphicon glyphicon-sort"></i></a></th> -->
            ...
            <tbody>
                <tr ng-repeat="data in filtered = (list | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit">
                    ...
                    <td><a href="update_movies.html?id={{data.id}}"><i class="glyphicon glyphicon-file"></i></a> 
                        <a href="delete_movies.html?id={{data.id}}" onClick="return ConfirmDelete();"><i class="glyphicon glyphicon-trash"></i></a>
                    </td>
<!--                     <td><a href="update_movies.html?id={{data.id}}"><i class="fa fa-pencil-square-o edit-delete-icon"></i></a> <a href="delete_movies.html?id={{data.id}}" onClick="return ConfirmDelete();"><i class="fa fa-trash-o edit-delete-icon"></i></a></td> -->
...
<script src="jsp/movies.js"></script>
<script>
