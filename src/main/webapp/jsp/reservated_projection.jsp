...
<!-- <br/> -->
    ...
    <div class="row">
        <div class="col-md-12" ng-show="filteredItems > 0">
            ...
            <th style="width: 16%;">Cinemas&nbsp;<a ng-click="sort_by('id_cinema');"><i class="glyphicon glyphicon-sort sort-arrows"></i></a></th>
            <th style="width: 16%;">Theatres&nbsp;<a ng-click="sort_by('id_theatre');"><i class="glyphicon glyphicon-sort sort-arrows"></i></a></th>
            ...
            <th style="width: 7%;">Date&nbsp;<a ng-click="sort_by('projection_date');"><i class="glyphicon glyphicon-sort sort-arrows"></i></a></th>
...
<!--             <th style="width: 9%;">Action&nbsp;<a ng-click="sort_by('status');"><i class="glyphicon glyphicon-sort sort-arrows"></i></a></th> -->
           </thead>
            <tbody>
                <tr ng-repeat="data in filtered = (list | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit">
                    ...
                    <td>{{data.projections.projection_date | date:"dd.MM.yyyy"}}</td>
...
<script src="jsp/reservated_projection.js"></script>
